...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1352: (t, s) => t.set(s),
      _1353: l => new DataView(new ArrayBuffer(l)),
      ...
      _1499: (o, p) => o[p],
      _1502: x0 => x0.random(),
      _1503: (x0,x1) => x0.getRandomValues(x1),
      _1504: () => globalThis.crypto,
...
"Gg==",
"Gw==",
"Our Free Android Applications",
"WrapCrossAlignment.",
"WrapAlignment.",
"appname",
"Password Manager: Safe Account",
"description",
"Secure Password Manager - Your trusted companion for password management.",
"appurl",
"https://play.google.com/store/apps/details?id=com.wriink.passwordmanager",
"appimageurl",
"https://image.winudf.com/v2/image1/Y29tLndyaWluay5wYXNzd29yZG1hbmFnZXJfaWNvbl8xNzEyNTQ4MTkyXzA5Ng/icon.webp?w=512&fakeurl=1&type=.webp",
"XML Configs: Camera Presets",
"Looking for a simple way to apply and manage camera configuration files? XML Config Manager is your all-in-one tool for exploring, downloading, and applying camera config files to get the best performance from supported apps.",
"https://play.google.com/store/apps/details?id=com.octocore.gcamconfig",
"https://image.winudf.com/v2/image1/Y29tLm9jdG9jb3JlLmdjYW1jb25maWdfaWNvbl8xNzUyMTUzMDI3XzAxNw/icon.webp?w=512&fakeurl=1&type=.webp",
"Drive Direct Link Generator",
"Discover the ultimate solution for hassle-free GDrive downloads with GDrive Direct Link. Whether your file is small or large, we've got you covered.",
"https://play.google.com/store/apps/details?id=com.wriink.gdrivedirect",
"https://image.winudf.com/v2/image1/Y29tLndyaWluay5nZHJpdmVkaXJlY3RfaWNvbl8xNzI1NjYzODQ0XzA1OQ/icon.webp?w=512&fakeurl=1&type=.webp",
"Hello! - OnScreen Message",
"Hello! Tools is a revolutionary app, useful in personalizing on screen messages and making them unique. You might be at a concert, discussing in a meeting, or far away and need to send a direct message.",
"https://play.google.com/store/apps/details?id=com.wriink.hello",
"https://i.ibb.co/rK8jPVbp/unnamed.jpg",
"platformDefault",
"inAppWebView",
"inAppBrowserView",
...
"externalApplication",
"LaunchMode.",
"https://i.ibb.co/230cJxkt/loading.jpg",
"noRepeat",
"ImageRepeat.",
...
"_imageHandler",
"Who we are",
"Wriink is dedicated to crafting innovative, user-centric Android applications that make a global impact. Our mission is to enhance daily life through technology that is both accessible and intuitive.",
"Innovation",
"User-Centric design",
"Global Impact",
"clamp",
...
"fitHeight",
"fitWidth",
"https://play.google.com/store/apps/dev?id=5443489054424412549",
"About",
"Portfalio",
"Contact us",
